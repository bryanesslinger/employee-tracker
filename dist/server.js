...
async function viewDepartments() {
    ...
    try {
        const result = await pool.query(sql); // Make sure you await the query
...
async function addRole() {
    ...
    try {
        const result = await pool.query(sql, [title, salary, department_id]);
...
async function addEmployee() {
    ...
    try {
        const result = await pool.query(sql, [first_name, last_name, role_id, manager_id || null]);
...
// // 7. Update an Employee's Role
// async function updateEmployeeRole() {
//     console.log('Prompting for employee ID and role ID...');
...
//         }
//         else {
//             console.log(`Employee role updated to: ${result.rows[0].role_id}`);
//         }
//     }
//     catch (err) {
//         console.error('Error updating employee role:', err);
...
//             await addEmployee();
//             break;
//         case 'Update a Role for Employee':
//             console.log('Update Employee Role Selected!');
//             console.log('Going to update employee role...');   
//         await updateEmployeeRole();
//             break;
//         case 'Exit':
//             console.log('Goodbye!');
...
//             break;
//     }
//     await mainMenu(); // Keep prompting until 'Exit' is selected
// }
// // Start the main menu when the server starts
// mainMenu();
